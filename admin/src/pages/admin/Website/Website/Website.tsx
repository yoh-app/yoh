...
ui.crudIntl = {
  ...
  createTitleId: '_Admin.Website._PageGroup.Website._Page.Website._CreateTitle',

  createDescription: 'Website Create Description',
  createDescriptionId: '_Admin.Website._PageGroup.Website._Page.Website._CreateDescription',

  updateTitle: 'Website Update Title',
  updateTitleId: '_Admin.Website._PageGroup.Website._Page.Website._UpdateTitle',

  updateDescription: 'Website Update Description',
  updateDescriptionId: '_Admin.Website._PageGroup.Website._Page.Website._UpdateDescription',

  deleteTitle: 'Website Delete Title',
  deleteTitleId: '_Admin.Website._PageGroup.Website._Page.Website._DeleteTitle',

  deleteDescription: 'Website Delete Description',
  deleteDescriptionId: '_Admin.Website._PageGroup.Website._Page.Website._DeleteDescription',

  listTitle: 'Website List Title',
  listTitleId: '_Admin.Website._PageGroup.Website._Page.Website._ListTitle',

  listDescription: 'Website List Description',
  listDescriptionId: '_Admin.Website._PageGroup.Website._Page.Website._ListDescription',
};
