...
import { useEnterAdminMutation, useInstallTemplateMutation, useCreateOnePageMutation, usePermissionQuery, useUpdateOneWebsiteMutation, useUpdateOneProductCollectionMutation, useUpdateOnePageCollectionMutation } from 'generated';
...
const PrismaTable: React.FC<ModelTableProps> = ({ children, websiteData, permissionData, language, model, ui, ...rest }) => {
  ...
  return (
    ...
    >
      ...
      <Template enterAdmin={enterAdmin} setTemplateView={setTemplateView} updateWebsite={updateWebsite} website={createdWebsite} templateView={templateView} setTemplate={setTemplate} />
    </TableContext.Provider>
  );
};
