...
const ShippingDeleteView = dynamic(() => import('components/shipping/shipping-delete-view'));
const CategoryDeleteView = dynamic(() => import('components/category/category-delete-view'));
const CouponDeleteView = dynamic(() => import('components/coupon/coupon-delete-view'));
const OrderDeleteView = dynamic(() => import('components/order/order-delete-view'));
const ProductDeleteView = dynamic(() => import('components/product/product-delete-view'));
const TypeDeleteView = dynamic(() => import('components/group/group-delete-view'));
const AttributeDeleteView = dynamic(() => import('components/attribute/attribute-delete-view'));
const OrderStatusDeleteView = dynamic(() => import('components/order-status/order-status-delete-view'));
const ApproveShopView = dynamic(() => import('components/shop/approve-shop-view'));
