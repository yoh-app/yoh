...
const CARDS = [
  {
    ...
    description:
      'yoh.app provides more than 100 kinds of unique template for you to mix and match the look of your site.',
  },
  {
    ...
    description:
      'Start selling your products with yoh.app. Sell physical goods, knoledge based videos, informational podcasts, and private links.',
  },
  // {
  ...
  // },
  {
    ...
    description:
      'Websites created with yo.app allows visitors to send advertisement requests to share their links on your site. Generate passive income when you share.',
  },
];
