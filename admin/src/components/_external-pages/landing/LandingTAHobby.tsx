        ...
        <Grid container spacing={5} direction="row-reverse" justifyContent="space-between">
            ...
            <ContentStyle>
              ...
              <MotionInView variants={varFadeInUp}>
                <Typography sx={{ color: 'common.white', mb: 5 }}>
                  Share your successes and get extra traffic and followers to other social networks.
                  Pixite creates google indexible SEO key words to make searches to your contents
                  easier.
                </Typography>
              </MotionInView>
            </ContentStyle>
          ...
          <Grid item xs={12} md={7} sx={{ position: 'relative' }}>
            <MotionInView threshold={0.5} variants={varFadeInUp}>
              <img alt="light mode" src="https://picsum.photos/500/400?random=4" />
            </MotionInView>
            <MotionInView
              threshold={0.5}
            ...
            >
              <img alt="dark mode" src="https://picsum.photos/500/400?random=3" />
            </MotionInView>
          </Grid>
        </Grid>
      </Container>
