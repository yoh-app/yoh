...
import yupSchema from 'yupSchema/Notification';
...
const ui = {
  ...
  intl: {
    title: 'Notification',
    titleId: '_Version.yoh-31._SchemaModel.Notification._Title',
    description: 'Notification Description',
    descriptionId: '_Version.yoh-31._SchemaModel.Notification._Description',
  },
