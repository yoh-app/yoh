...
import yupSchema from 'yupSchema/PageView';
...
const ui = {
  ...
  intl: {
    title: 'PageView',
    titleId: '_Version.yoh-31._SchemaModel.PageView._Title',
    description: 'PageView Description',
    descriptionId: '_Version.yoh-31._SchemaModel.PageView._Description',
  },
