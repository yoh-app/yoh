...
import yupSchema from 'yupSchema/ExternalNft';
const ui = {
  name: 'ExternalNft',
  ...
  intl: {
    title: 'ExternalNft',
    titleId: '_Version.yoh-12._SchemaModel.ExternalNft._Title',
    description: 'ExternalNft Description',
    descriptionId: '_Version.yoh-12._SchemaModel.ExternalNft._Description',
  },
