...
import yupSchema from 'yupSchema/LoginToken';
...
const ui = {
  ...
  intl: {
    title: 'LoginToken',
    titleId: '_Version.yoh-31._SchemaModel.LoginToken._Title',
    description: 'LoginToken Description',
    descriptionId: '_Version.yoh-31._SchemaModel.LoginToken._Description',
  },
