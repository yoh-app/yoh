...
import yupSchema from 'yupSchema/EventGroup';
...
const ui = {
  ...
  intl: {
    title: 'EventGroup',
    titleId: '_Version.yoh-31._SchemaModel.EventGroup._Title',
    description: 'EventGroup Description',
    descriptionId: '_Version.yoh-31._SchemaModel.EventGroup._Description',
  },
