...
import yupSchema from 'yupSchema/Customer';
...
const ui = {
  ...
  intl: {
    title: 'Customer',
    titleId: '_Version.yoh-31._SchemaModel.Customer._Title',
    description: 'Customer Description',
    descriptionId: '_Version.yoh-31._SchemaModel.Customer._Description',
  },
