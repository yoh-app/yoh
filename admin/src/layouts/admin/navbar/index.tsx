...
// @mui
import { styled, useTheme, createTheme, ThemeProvider, ThemeOptions } from '@mui/material/styles';
...
export default function DashboardNavbar({ isOpenSidebar, onCloseSidebar, menu }: Props) {
  ...
  const renderContent = (
    <ThemeProvider darkMode={true}>
      ...
      >
        ...
        <NavSection navConfig={menu ? menu : []} isCollapse={isCollapse} />
