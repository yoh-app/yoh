  ...
  return (
    ...
    >
      ...
      <header className="p-3 md:p-6">
        <h3 className="text-xs md:text-sm text-body truncate cursor-pointer" onClick={handleProductQuickView}>
          {name}
        </h3>
        {/* End of product name */}
          ...
          {product_type === 'variable' ? (
            ...
            <>
              <div className="flex md:items-center flex-col md:flex-row">
                <span className="text-sm md:text-base text-heading font-semibold">{basePrice ? basePrice : price}</span>
              ...
              {quantity > 0 ? (
                ...
                <div className="bg-red-500 rounded text-xs text-light px-1 py-1 truncate">Out Of Stock</div>
              )}
            </>
          )}
