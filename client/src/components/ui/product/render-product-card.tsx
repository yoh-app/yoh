...
const Helium = dynamic(() => import("@components/ui/product/product-card/helium"));
const Neon = dynamic(() => import("@components/ui/product/product-card/neon"));
const Argon = dynamic(() => import("@components/ui/product/product-card/argon"));
const Krypton = dynamic(
  () => import("@components/ui/product/product-card/krypton")
);
const Xenon = dynamic(() => import("@components/ui/product/product-card/xenon"));
