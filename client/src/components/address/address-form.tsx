...
const addressSchema = yup.object().shape({
  type: yup.string().oneOf(['billing', 'shipping']).required('error-type-required'),
...
const CreateOrUpdateAddressForm = () => {
  ...
  return (
    <div className="p-5 sm:p-8 bg-light">
      ...
      <form onSubmit={handleSubmit(onSubmit)} noValidate className="grid grid-cols-2 gap-5 h-full">
        <div>
