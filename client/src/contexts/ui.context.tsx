...
import { AuthContext as SessionContext } from '@contexts/session.context';
...
type SIDEBAR_VIEW = 'CART_VIEW' | 'FILTER_VIEW' | 'FILTER_LAYOUT_TWO_VIEW' | 'MAIN_MENU_VIEW' | 'AUTH_MENU_VIEW';
...
export const UIProvider: FC = (props) => {
  ...
  const setSidebarView = (view: SIDEBAR_VIEW) => dispatch({ type: 'SET_SIDEBAR_VIEW', view });
  ...
  const { isAuthenticated } = React.useContext(
    process.env.NEXT_PUBLIC_AUTH === 'magic' ? MagicContext : SessionContext,
  );
