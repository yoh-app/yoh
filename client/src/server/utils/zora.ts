export const createdDropAbi = {
  guessFromInterface: false,
  iface: [
    'constructor(address _zoraFeeManager, address _zoraERC721TransferHelper)',
    ...
    'event SalesConfigChanged(address indexed changedBy, tuple(uint104 publicSalePrice, uint32 maxSalePurchasePerAddress, uint64 publicSaleStart, uint64 publicSaleEnd, uint64 presaleStart, uint64 presaleEnd, bytes32 presaleMerkleRoot) salesConfig)',
    'event Transfer(address indexed from, address indexed to, uint256 indexed tokenId)',
    'function DEFAULT_ADMIN_ROLE() view returns (bytes32)',
    'function MINTER_ROLE() view returns (bytes32)',
    'function SALES_MANAGER_ROLE() view returns (bytes32)',
    'function adminMint(address recipient, uint256 quantity) returns (uint256)',
    'function adminMintAirdrop(address[] recipients) returns (uint256)',
    ...
    'function initialize(string _name, string _symbol, address _owner, address _fundsRecipient, uint64 _editionSize, uint16 _royaltyBPS, address _metadataRenderer, bytes _metadataRendererInit)',
    'function isAdmin(address user) view returns (bool)',
    'function isApprovedForAll(address nftOwner, address operator) view returns (bool)',
    'function metadataRenderer() view returns (address)',
    'function mintedPerAddress(address minter) view returns (tuple(uint256 totalMints, uint256 presaleMints, uint256 publicMints))',
    'function name() view returns (string)',
    'function owner() view returns (address)',
    'function ownerOf(uint256 tokenId) view returns (address)',
    'function presaleMintsByAddress(address) view returns (uint256)',
    'function purchase(uint256 quantity) payable returns (uint256)',
    'function purchasePresale(uint256 quantity, uint256 maxQuantity, uint256 pricePerToken, bytes32[] merkleProof) payable returns (uint256)',
    'function renounceRole(bytes32 role, address account)',
    'function revokeRole(bytes32 role, address account)',
    'function royaltyInfo(uint256, uint256 _salePrice) view returns (address receiver, uint256 royaltyAmount)',
    'function safeTransferFrom(address from, address to, uint256 tokenId)',
    'function safeTransferFrom(address from, address to, uint256 tokenId, bytes _data)',
    'function saleDetails() view returns (tuple(bool presaleActive, bool publicSaleActive, uint64 publicSaleStart, uint64 publicSaleEnd, uint256 publicSalePrice, uint64 presaleStart, uint64 presaleEnd, bytes32 presaleMerkleRoot, uint256 maxSalePurchasePerAddress, uint256 totalMinted, uint256 maxSupply))',
    ...
    'function setFundsRecipient(address newRecipientAddress)',
    'function setOwner(address newOwner)',
    'function setSaleConfiguration(tuple(uint104 publicSalePrice, uint32 maxSalePurchasePerAddress, uint64 publicSaleStart, uint64 publicSaleEnd, uint64 presaleStart, uint64 presaleEnd, bytes32 presaleMerkleRoot) newConfig)',
    ...
    'function withdraw()',
    'function zoraFeeForAmount(uint256 amount) returns (address, uint256)',
    'function zoraFeeManager() view returns (address)',
  ],
  abi: [
    {
      inputs: [
        { internalType: 'contract IZoraFeeManager', name: '_zoraFeeManager', type: 'address' },
        { internalType: 'address', name: '_zoraERC721TransferHelper', type: 'address' },
      ],
    ...
    },
    {
      ...
      inputs: [
        ...
        { indexed: false, internalType: 'uint256', name: 'numberOfMints', type: 'uint256' },
      ],
    ...
    },
    {
      ...
      inputs: [
        ...
        { indexed: true, internalType: 'uint256', name: 'pricePerToken', type: 'uint256' },
        { indexed: false, internalType: 'uint256', name: 'firstPurchasedTokenId', type: 'uint256' },
      ],
      name: 'Sale',
      type: 'event',
    },
    {
      ...
      inputs: [
        { indexed: true, internalType: 'address', name: 'changedBy', type: 'address' },
        {
          ...
          indexed: false,
          internalType: 'struct ERC721Drop.SalesConfiguration',
          name: 'salesConfig',
          type: 'tuple',
        },
      ],
    ...
    { inputs: [], name: 'finalizeOpenEdition', outputs: [], stateMutability: 'nonpayable', type: 'function' },
    {
      inputs: [{ internalType: 'uint256', name: 'tokenId', type: 'uint256' }],
      name: 'getApproved',
    ...
    },
    {
      inputs: [
        ...
        { internalType: 'address payable', name: '_fundsRecipient', type: 'address' },
        { internalType: 'uint64', name: '_editionSize', type: 'uint64' },
        { internalType: 'uint16', name: '_royaltyBPS', type: 'uint16' },
        { internalType: 'contract IMetadataRenderer', name: '_metadataRenderer', type: 'address' },
    ...
    },
    {
      ...
      outputs: [{ internalType: 'contract IMetadataRenderer', name: '', type: 'address' }],
      stateMutability: 'view',
      type: 'function',
    },
    {
      ...
      outputs: [
        {
          components: [
            ...
            { internalType: 'uint64', name: 'presaleEnd', type: 'uint64' },
            { internalType: 'bytes32', name: 'presaleMerkleRoot', type: 'bytes32' },
            { internalType: 'uint256', name: 'maxSalePurchasePerAddress', type: 'uint256' },
    ...
    {
      inputs: [{ internalType: 'address payable', name: 'newRecipientAddress', type: 'address' }],
